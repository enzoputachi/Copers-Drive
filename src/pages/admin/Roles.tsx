...
const AdminRoles = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Role Management | Corpers Drive Admin</title>
      </Helmet>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2">
            <p className="text-sm text-muted-foreground">
              ...
              different combinations of permissions to control access to Corpers Drive features.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Corpers Drive comes with predefined roles to help you get started quickly. These roles 
