...
const recentActivities: ActivityItem[] = [
  {
    ...
    user: { name: "Admin User", email: "admin@transitx.ng" }
  },
  {
    id: "2",
    action: "updated bus",
    ...
    user: { name: "Operation Manager", email: "ops@transitx.ng" }
  },
  {
    id: "3",
    ...
    user: { name: "Support Staff", email: "support@transitx.ng" }
  },
  {
    id: "4",
    ...
    user: { name: "Finance Admin", email: "finance@transitx.ng" }
  },
  {
    id: "5",
...
const AdminDashboard = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard | TransitX Admin</title>
      </Helmet>
