...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-green-50">
      <Helmet>
        <title>About Us - TransitX</title>
        <meta name="description" content="Learn about TransitX - Nigeria's leading transportation service for NYSC corps members. Our mission, vision, and dedicated team." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                The dedicated professionals driving TransitX forward with passion and expertise
              </p>
            </div>
